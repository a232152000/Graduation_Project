...
pp=dbGetQuery(con, "select PostMessage from test WHERE POST_FeedBack=1 AND number<1001")
ppn=dbGetQuery(con, "select PostId from test WHERE POST_FeedBack=1 AND number<1001")
ppnt=dbGetQuery(con, "select POST_FeedBack from test WHERE POST_FeedBack=1 AND number<1001")
...
pn=dbGetQuery(con, "select PostMessage from test WHERE POST_FeedBack=-1 AND number<1001")
pnn=dbGetQuery(con, "select PostId from test WHERE POST_FeedBack=-1 AND number<1001")
pnnt=dbGetQuery(con, "select POST_FeedBack from test WHERE POST_FeedBack=-1 AND number<1001")
...
n=dbGetQuery(con, "select PostMessage from test WHERE affect=0 AND number<1001")
nn=dbGetQuery(con, "select PostId from test WHERE affect=0 AND number<1001")
nnt=dbGetQuery(con, "select POST_FeedBack from test WHERE affect=0 AND number<1001")
